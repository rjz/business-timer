...
exports.DEFAULTS = exports.DEFAULT_HOURS = void 0;
var SECOND = 1000;
...
var BusinessTimer = /** @class */ (function () {
    function BusinessTimer(_a) {
        ...
        var _b = _a === void 0 ? exports.DEFAULTS : _a, _c = _b.holidays, holidays = _c === void 0 ? [] : _c, _d = _b.hours, hours = _d === void 0 ? exports.DEFAULT_HOURS : _d, _e = _b.timeZone, timeZone = _e === void 0 ? null : _e;
    ...
    BusinessTimer.prototype.isWorkday = function (date) {
        var ts = this._toTimestamp(date);
        return this._isWorkday(ts);
    };
    /** Check whether the business is open at the given time */
    BusinessTimer.prototype.isOpen = function (datetime) {
        var ts = this._toTimestamp(datetime);
    ...
    BusinessTimer.prototype._toTimestamp = function () {
        ...
        var hackyISODate = this._dateTimeFormat.format(d).replace(/\//g, '-').replace(", ", "T") + "Z";
        return new Date(hackyISODate).getTime();
    };
    BusinessTimer.prototype._isWorkday = function (ts) {
