...
var BusinessTimer = /** @class */ (function () {
    function BusinessTimer(_a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.holidays, holidays = _c === void 0 ? [] : _c, _d = _b.hours, hours = _d === void 0 ? exports.DEFAULT_HOURS : _d, _e = _b.timeZone, timeZone = _e === void 0 ? null : _e;
    ...
    BusinessTimer.prototype._toUTC = function (d) {
        if (!this._tzFormatter) {
            return d;
        }
        var hackyISODate = this._tzFormatter.format(d).replace(", ", "T") + "Z";
    ...
    BusinessTimer.prototype.diff = function (start, end) {
        var d1 = this._toUTC(new Date(start));
        var d2 = this._toUTC(new Date(end));
